        ...
        <VCard>
          ...
          <VCardText>
            ...
            <div class="mb-4">
              ...
              >
                <VTimelineItem
                  v-for="(etape, idx) in p.etapes"
                  :key="idx"
                  :dot-color="getStatutColor(etape.statut)"
                  size="small"
                >
                  <div class="d-flex align-center justify-space-between">
                    <div class="d-flex align-center gap-2">
                      <VIcon
                        :icon="getStatutIcon(etape.statut)"
                        size="18"
