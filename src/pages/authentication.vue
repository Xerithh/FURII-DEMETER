      ...
      <VRow no-gutters class="auth-split-row">
        ...
        <VCol cols="12" md="6" class="auth-right-panel">
          <div class="auth-form-wrap">
            ...
            <template v-if="isLogin">
              ...
              <VForm @submit.prevent="$router.push('/')">
                ...
                <div class="form-actions">
                  <div class="fa-left">
                    <VCheckbox v-model="loginForm.remember" label="Se souvenir de moi" />
                  </div>
                  <div class="fa-right" />
                </div>

                <VBtn block size="large" type="submit" class="mb-5">Connexion</VBtn>

                <p class="text-center text-body-1">
                  Nouveau sur ISISU ?
                  <RouterLink to="/register" class="text-primary ms-1">Creer un compte</RouterLink>
                </p>
              </VForm>
            </template>
            ...
            <!-- Register Form -->
            <template v-else>
              <h3 class="text-h4 font-weight-bold mb-2">Creer un compte</h3>
              <p class="auth-intro text-body-1 text-medium-emphasis mb-8">
                Rejoignez la plateforme pour lancer votre evaluation adaptative.
              </p>
              ...
              <VForm @submit.prevent="$router.push('/')">
                ...
                <div class="form-actions">
                  <div class="fa-left">
                    <VCheckbox id="privacy-policy" v-model="registerForm.privacyPolicies" />
                  </div>
                  <div class="fa-right">
                    <a href="javascript:void(0)" class="text-primary policy-link">Politique de confidentialité</a>
                  </div>
                </div>

                <VBtn block size="large" type="submit" class="mb-5">S'inscrire</VBtn>

                <p class="text-center text-body-1">
                  Deja un compte ?
                  <RouterLink class="text-primary ms-1" to="/login">Se connecter</RouterLink>
                </p>
              </VForm>
            </template>
